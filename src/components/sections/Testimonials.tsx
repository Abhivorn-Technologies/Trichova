...
const testimonials = [
  ...
  },
  {
    ...
    grafts: 3100,
    rating: 5,
    text: "The combination of GFC treatment with DHI was suggested by the doctor after thorough analysis. This personalized approach gave me superior results. My hair is thicker, denser, and the growth was faster than expected. The clinic infrastructure is world-class. Genuinely transformed my confidence.",
